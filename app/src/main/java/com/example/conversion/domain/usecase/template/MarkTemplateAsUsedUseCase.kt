...
/**
 * Use case for marking a template as used.
 * Updates the lastUsedAt timestamp to track template usage.
 *
 * Input: String - The template ID
 * Output: Unit - Success or failure
 */
class MarkTemplateAsUsedUseCase @Inject constructor(
    private val templateRepository: TemplateRepository,
    @IoDispatcher dispatcher: CoroutineDispatcher
) : BaseUseCase<String, Unit>(dispatcher) {

    /**
     * Executes the use case to mark a template as used.
     *
